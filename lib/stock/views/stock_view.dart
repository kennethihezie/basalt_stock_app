...
class _StockViewState extends State<StockView> {
    ...
    return Scaffold(
      appBar: AppBar(
        title: !_isSearchEnabled ? Padding(
          ...
          child: textHeading5("Stocks", BasaltColors.white),
        ) : Container(
  ...
  Widget _viewController(StockState state){
    switch(state.status){
      ...
      case StockStatus.failure:
        return Center(child: textSemiBold("Failed to fetch stocks", BasaltColors.A181212));
    }
  }
  ...
  Widget _displayAllStocks(List<Stock> stocks){
    ...
    return CustomScrollView(
      slivers: [
        _isSearchEnabled ?  SliverList(delegate: SliverChildListDelegate([])) : SliverList(delegate: SliverChildListDelegate([
          Row(
            mainAxisAlignment: MainAxisAlignment.start,
              ...
              Expanded(
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                         textMiniTextRegular(date, BasaltColors.A181212),
                      ],
                    ),
                  )),
                  ...
                  child: Container(
                    ...
                    child: DropdownButtonHideUnderline(
                        child: DropdownButton<String>(
                          hint:
                          textMiniTextRegular(period, BasaltColors.A181212),
                          items: <String>[
                            'Today',
                            'Last 7 days',
                            'A month',
        ...
        SliverList(delegate: SliverChildBuilderDelegate((context, index) => StockModel(stock: stocks[index],), childCount: stocks.length))
      ],
    );
  }
